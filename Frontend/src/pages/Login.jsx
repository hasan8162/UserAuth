...
const Login = () => {
   ...
   return (
        <form onSubmit={onSubmitHandler} className="bg-white text-gray-500 max-w-[340px] w-full mx-4 md:p-6 p-4 py-8 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
